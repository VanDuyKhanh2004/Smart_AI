      ...
      '/api/products': {
        ...
        post: {
              ...
              'multipart/form-data': {
                schema: {
                  ...
                  properties: {
                    ...
                    description: { type: 'string' },
                    inStock: { type: 'integer' },
                    image: { type: 'string', format: 'binary', description: 'Image file (image/jpeg, image/png, image/webp). Max 5 MB.' },
                    specs: { type: 'string', description: 'JSON string' },
                    colors: { type: 'string', description: 'JSON array string' },
          ...
          responses: {
            ...
            400: { description: 'Validation error, invalid file, or image source conflict' },
            403: { description: 'Not authorized' },
          },
        },
      },
